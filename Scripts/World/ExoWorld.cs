...
public class ExoWorld : Node
{
    ...
    public ExoWorld()
    {
        this.Atmosphere = new Atmosphere(new GasEscapingAC(), new ColorMixingAtmosphereComponent());
        this.Bacteria = new BacterialState(new AsymptoticGrowthBSC(), new ProductionBSC());
    }
